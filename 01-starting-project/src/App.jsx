...
function App() {
 ...
 const[modalIsOpen, setModalIsOpen]= useState(false);
  ...
  }, []); //use Effect doesn't return value it needs two arguments
  //After this component executed useEffect will be executed
  ...
  function handleSelectPlace(id) {
    ...
    //localStorage coming from browser. data will store in browser
    const storeIds = JSON.parse(localStorage.getItem('selectedPlaces')) || [];
